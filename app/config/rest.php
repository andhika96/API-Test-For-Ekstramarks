...
$config['rest_realm'] = 'Aruna REST API';
...
// JWT Exmaple
$config['auth_override_class_method_http']['jwt']['token_post']['post'] = 'none';
$config['auth_override_class_method_http']['jwt']['token_refresh_get']['get'] = 'jwt';
...
$config['rest_keys_table'] = 'ar_keys';
...
$config['rest_key_name'] = 'Ar-API-Key';
...
|
*/
$config['rest_limits_table'] = 'ar_limits';
